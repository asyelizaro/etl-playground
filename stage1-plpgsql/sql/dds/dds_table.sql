...
-- таблицы измерений
CREATE TABLE IF NOT EXISTS dds.t_dim_album (
...
CREATE TABLE IF NOT EXISTS dds.t_dim_artist (
    artist_id INTEGER PRIMARY KEY,
    "name" VARCHAR(120) NOT NULL,
    created_at TIMESTAMP DEFAULT NOW()
);

CREATE TABLE IF NOT EXISTS dds.t_dim_genre (
    genre_id INTEGER PRIMARY KEY,
    "name" VARCHAR(120) NOT NULL,
    created_at TIMESTAMP DEFAULT NOW()
);

CREATE TABLE IF NOT EXISTS dds.t_dim_track (
...
CREATE TABLE IF NOT EXISTS dds.t_dim_customer (
...
CREATE TABLE IF NOT EXISTS dds.t_dim_employee (
...
CREATE TABLE IF NOT EXISTS dds.t_dim_date (
